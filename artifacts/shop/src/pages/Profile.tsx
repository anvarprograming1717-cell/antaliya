...
export default function Profile() {
  ...
  const telegramPhoto = (customer as any)?.telegramPhoto ?? null;
  const telegramUsername = (customer as any)?.telegramUsername ?? null;
    ...
    <div className="min-h-screen pb-6">
      ...
      >
        ...
        <div className="relative w-24 h-24 mb-4">
          <div className="w-24 h-24 rounded-full bg-primary/20 flex items-center justify-center shadow-xl overflow-hidden">
            {telegramPhoto ? (
              <img
                src={telegramPhoto}
                alt="Telegram avatar"
          ...
          {/* Telegram badge */}
          {(customer as any)?.telegramId && (
            <div className="absolute -bottom-0.5 -right-0.5 w-7 h-7 bg-[#2AABEE] rounded-full flex items-center justify-center shadow-md border-2 border-background">
        ...
        {telegramUsername && (
          <a
            ...
            className="flex items-center gap-1.5 text-[#2AABEE] text-sm font-medium mb-1 hover:underline"
          >
