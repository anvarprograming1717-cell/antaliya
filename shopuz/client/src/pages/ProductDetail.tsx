...
export default function ProductDetail() {
  ...
  const stickyBar = createPortal(
    <div
      className="fixed left-0 right-0 z-[200] px-4 pb-3"
      style={{ bottom: "72px" }}
    >
      <div className="glass rounded-3xl shadow-2xl flex items-center gap-3 px-4 py-3 max-w-md mx-auto">
